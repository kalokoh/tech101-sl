  ...
  return (
    <React.Fragment>
      <div className={classes.title_container}>
        <h1 className={classes.title}>Cascading Style Sheet CSS</h1>
      </div>
      <div className={classes.course_details}>
        <h2 className={classes.introduction}>INTRODUCTION</h2>
         
         <p>Websites we build should be attractive and user friendly, in the sense, users of the websites should be able to navigate the website easily and perform different actions effectively. In the end, this enhances good user experience. We have understood that, Hypertext Markup Language (HTML) is used to build the structure of websites, but this is not enough for the websites. We need to design or style the website so it appears attractive to users, for this purpose, we utilize Cascading Style Sheet (CSS) to achieve this. </p>
         <br />
         <p>CSS is a stylesheet that describes how contents created with HTML are presented on screens for users. The concept of how HTML elements are presented on the screen was proposed by Wium Lie in 1994. CSS is among the languages are that are regarded as cornerstone technologies of the web with HTML and Javascript. This makes it very relevant for us to learn CSS to design our websites efficiently. In this course, three types of CSS will be taught that is; inline, internal, and external CSS </p>
