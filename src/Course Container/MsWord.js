  ...
  return (
    <React.Fragment>
      <div className={classes.title_container}>
        <h1 className={classes.title}>Micrsoft Word</h1>
      </div>
      <div className={classes.course_details}>
        <h2 className={classes.introduction}>INTRODUCTION</h2>

        <p>
          Microsoft Word commonly known as MS word is an application software developed and published by <a href='https://www.microsoft.com/en-us/?ql=3' target='_blank'> Microsoft </a> company. MS Word is the most commonly used word processor for creating fantastic and high quality documents like curriculum vitae (CV), resume, letters, assigments, question papers and many other documents. Microsoft Word is used in almost every office today, and as a result of this fact, it is very crucial for one looking for employment to learn MS word and add it to their resume and increase their probability of getting hired by a company. In this Microsoft Word course, both basic and advanced concepts are taught with real world examples
        </p>
