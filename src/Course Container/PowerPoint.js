  ...
  return (
    <React.Fragment>
      <div className={classes.title_container}>
        <h1 className={classes.title}>Microsoft PowerPoint</h1>
      </div>
      <div className={classes.course_details}>
        <h2 className={classes.introduction}>INTRODUCTION</h2>

        <p>
          Microsoft PowerPoint commonly known as PowerPoint is an application software developed and published by <a href='#' target='_blank'> Microsoft </a> company. MS PowerPoint is the most commonly used application for creating fantastic and high quality presentaions like class presentation, a workshop presentation, public talks, and many other kinds of presentations can be created using Microsoft PowerPoint. Microsoft PowerPoint is used in almost every office today, and as a result of this fact, it is very crucial for one looking for employment to learn MS PowerPoint and add it to their resume and increase their probability of getting hired by a company. </p>
          
          <p>In this Microsoft PowerPoint course, both basic and advanced concepts are taught with real world examples
        </p>

        <p>It is very important to note that, this course (Microsoft PowerPoint) is largely focused on practicals, for this reason, practical assignments and tests will be conducted during the course.</p>
