  ...
  return (
    <React.Fragment>
      <div className={classes.title_container}>
        <h1 className={classes.title}>Advanced Excel</h1>
      </div>
      <div className={classes.course_details}>
        <h2 className={classes.introduction}>INTRODUCTION</h2>

        <p>
        Data! Data! Data! I can't make bricks without clay. This famous quote was said by Sherlock Holmes in 'The Adventure of the Copper Beeches'. This quote explains the importance data. Today, for companies or businesses to grow and succeed, one of the major requirements is data, how it is been collected, analysed, managed, and stored. In the sense businesses use data to ensure their smooth running. Managing data with the appropriate tool is also crucial. Microsoft Excel commonly known as Excel is an application software developed and published by <a href='#' target='_blank'> Microsoft </a> company. </p>
        
        <br />

        <p>MS Excel is one of most used spreadsheets for performing explicit data processes like data collection, data analysis, and storage of data. It is a spreadsheet built with several capabilties to ensure that storage and management of data is no big deal. Microsoft Excel is used in almost every office today, and as a result of this fact, it is very crucial for one looking for employment to learn MS Excel and add it to their resume and increase their probability of getting hired by a company.
        </p>

        <p> In this course, we will build on the concept learnt from basic excel course by teaching advanced concepts in Excel with real-world projects. Topics such as formulas, data integrity, data analysis etc. will be taught.</p>
