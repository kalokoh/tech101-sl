  ...
  return (
    <React.Fragment>
      <div className={classes.title_container}>
        <h1 className={classes.title}>Basic Excel</h1>
      </div>
      <div className={classes.course_details}>
        <h2 className={classes.introduction}>INTRODUCTION</h2>

        <p>
          Data! Data! Data! I can't make bricks without clay. This famous quote was said by Sherlock Holmes in 'The Adventure of the Copper Beeches'. This quote explains the importance data. Today, for companies or businesses to grow and succeed, one of the major requirements is data, how it is been collected, analysed, managed, and stored. In the sense businesses use data to ensure their smooth running. Managing data with the appropriate tool is also crucial. Microsoft Excel commonly known as Excel is an application software developed and published by <a href='#' target='_blank'> Microsoft </a> company. MS Excel is one of most used spreadsheet for performing explicit data processes like data collection, data analysis, and storage of data. It is a spreadsheets built with several capabilties to ensure that storage and management of data is no big deal. </p>
          
           <br/>
          <p>
          Microsoft Excel is used in almost every office today, and as a result of this fact, it is very crucial for one looking for employment to learn MS Excel and add it to their resume and increase their probability of getting hired by a company. Due to the complicity of the software, in this Microsoft Excel course, only basic concepts are taught with real world examples. This prepares you for the Advance Excel course.
        </p>

        <p>It is very important to note that, this course (Microsoft Excel) is largely focused on practicals, for this reason, practical assignments and tests will be conducted during the course.</p>
        ...
        <p className={classes.table_title}>Course Details</p>
          <table style={{border: '1px solid black' , paddingLeft: '1rem'}}>
            ...
            <tr>
            <td style={{border: '1px solid black', paddingLeft: '1rem'}} >Microsoft Basic</td>
            <td style={{border: '1px solid black' , paddingLeft: '1rem'}}>Microsoft PowerPoint</td>
