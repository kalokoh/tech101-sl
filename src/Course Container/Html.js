  ...
  return (
    <React.Fragment>
      <div className={classes.title_container}>
        <h1 className={classes.title}>Hypertext Markup Language HTML</h1>
      </div>
      <div className={classes.course_details}>
        <h2 className={classes.introduction}>INTRODUCTION</h2>

        <p>
          HTML stands for Hypertext Markup Language. It is a markup language. Its first version was written by Tim Berners-Lee in 1993. HTML as a markup language is one of the fundamental languages you have learn to get into the world of web development and it is largely used by web developers to build the structure of different websites. Websites are eminent way of providing data to people or customers, and apparently every company or business is adopting this method. This means that, the demand for web developers is increasing and will continue to increase.
        </p>

        <br />

        <p>A website may contain many web pages, the structure of these web pages are built with this markup language (HTML). In this HTML course, we will teach you basic and advance concepts used in building the structure of these web pages with real-world examples.</p>

        <p>It is very important to note that, this course (HTML) is largely focused on practicals, for this reason, practical assignments and tests will be conducted during the course.</p>
        ...
        <p className={classes.table_title}>Course Details</p>
          <table style={{border: '1px solid black' , paddingLeft: '1rem'}}>
            ...
            <tr>
            <td style={{border: '1px solid black', paddingLeft: '1rem'}} >HTML</td>
            <td style={{border: '1px solid black' , paddingLeft: '1rem'}}>Programming Fundamentals</td>
            <td style={{border: '1px solid black' , paddingLeft: '1rem'}}>1-2 Months</td>
            </tr>
